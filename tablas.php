...
if ($result->num_rows > 0) {
    echo "<h1>Histórico producción mundial de " . htmlspecialchars(strtolower($item_name)) . "</h1>";
    echo "<table border='1'>
            <tr>
                <th>País</th>
                <th>1961</th>
    ...
    echo "No se encontraron resultados para el Item Code: " . htmlspecialchars($item_code);
}
