...
<body>
    <div class="content">
        ...
        <p>Esta es una lista histórica de países por producción de <?php echo htmlspecialchars($item_name, ENT_QUOTES, 'UTF-8'); ?>, basada en los datos de la Organización de las Naciones Unidas para la Alimentación y la Agricultura. La producción mundial total de <?php echo htmlspecialchars($item_name, ENT_QUOTES, 'UTF-8'); ?> en <?php echo $lastyear; ?> era de <?php echo $toneladas; ?> toneladas. <?php echo htmlspecialchars($highest_country, ENT_QUOTES, 'UTF-8'); ?> es el mayor productor, representando el <?php echo $percentage_highest_producer; ?>% de la producción mundial.</p>
